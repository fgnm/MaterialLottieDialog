...
class MaterialLottieDialog : AlertDialog {
    ...
    data class Builder(
        ...
        fun setDescription(description: CharSequence?): Builder = apply { this.description = description; return@apply }
        ...
        fun setCustomView(view: View?): Builder = apply { this.customView = view; return@apply }
        fun build() = MaterialLottieDialog(context!!, type, title, description, positiveText,
            negativeText, noneText, positiveListener, negativeListener, noneListener,
            positiveBtnColor, positiveTextColor, negativeBtnColor, negativeTextColor, noneBtnColor, noneTextColor, customAsset, customView)
    ...
    private fun findView() {
        ...
        customLayoutContainer = findViewById(R.id.customView)
        setView()
    }
    ...
    private fun setView() {
        ...
        if (mPositiveText != null) {
            ...
            btnPositive.setOnClickListener { mPositiveListener?.onClick(MaterialLottieDialog@ this) }
        } else {
        ...
        if (mNegativeText != null) {
            ...
            btnNegative.setOnClickListener { mNegativeListener?.onClick(MaterialLottieDialog@ this) }
        } else {
        ...
        if (mNoneText != null) {
            ...
            btnNone.setOnClickListener { mNoneListener?.onClick(MaterialLottieDialog@ this) }
        } else {
        ...
        if (mCustomView != null)
            customLayoutContainer.addView(mCustomView)
    }
    ...
    fun changeDialog(builder: Builder) {
        ...
        mCustomView = builder.getCustomView()
